...
# We want to insert the routes right before the Vite middleware block
# The Vite middleware block starts with "if (process.env.NODE_ENV !== "production") {"
...
<body>
    <div class="receipt-container">
        <img src="/api/tagihan-nota-image?data=${req.query.data}" alt="Nota Tagihan" />
...
if pos != -1:
    content = content[:pos] + routes + content[pos:]
